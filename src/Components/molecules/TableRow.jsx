...
const TableRow = ({ id, date, status, price, type }) => {
  return (
    <tr className="border-b border-gray-300">
      ...
      {type === "wishlist" && (
        <>
          <div className="flex gap-3 items-center h-full  py-4">
            <div>
            ...
            <div className="flex items-center gap-4">
              <img src="/src/assets/images/blogs/blog1.jpg" alt="" className="h-16" />
              <div>
          ...
          <TableCell className="w-6 ">
            <button className="bg-black px-6 py-2 flex justify-center items-center rounded-lg text-white font-inter font-medium text-base leading-7">Add to Cart</button>
          </TableCell>
        </>
      )}
    </tr>
